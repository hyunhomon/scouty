...
| 슬로건 | `말보다는 만든 것으로` |
| Primary | 승인된 로고의 파란색. 확정 전 `#3157F6` |
| 심볼 | 승인된 별·궤도 모티프 |

기능 코드에 브랜드 색상을 하드코딩하지 않고 디자인 토큰으로 관리한다.
...
- Google 또는 Kakao OAuth 중 최소 하나를 지원한다.
